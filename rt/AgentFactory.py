...
class AgentFactory:
    ...
    @staticmethod
    def make(agent_type: AgentType, response_wait_interval: int = 5, initialization_interval: int = 2, chat_initialization_interval: int = 0, chat_switch_interval: int = 1):
        match agent_type:
            case AgentType.MISTRAL:
                return MistralAgent(
                    ...
                    chat_switch_interval = chat_switch_interval
                )
            case _:
